...
export function Topbar({ name, email, roles }: { name: string; email: string; roles: Role[] }) {
  return (
    <header className="sticky top-3 z-30 mx-3 flex h-14 items-center justify-between rounded-[24px] border border-border bg-card/95 px-4 shadow-lg shadow-black/[0.08] backdrop-blur supports-backdrop-filter:bg-card/85 lg:hidden dark:shadow-black/30">
