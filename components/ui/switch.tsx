  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-4.5 translate-x-0.5 rounded-full bg-background shadow-lg ring-0 transition-transform data-checked:translate-x-[1.125rem]"
      />
    </SwitchPrimitive.Root>
  )
}
